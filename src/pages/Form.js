...
function AddRecipe ({onAddRecipe}){
    ...
    const newRecipe = {recipeName,image,
    ...
    fetch("http://localhost:3000/recipes", {
        ...
        .then(recipe => {onAddRecipe(recipe);alert("Recipe added successfully!");
    ...
    return (
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input type="text" name="instructions" placeholder="Instructions" value={instructions} onChange={(e) => setInstructions(e.target.value)} />
